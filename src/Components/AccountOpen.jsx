const AccountOpen = ({title,description}) => {
  return (
    <>
      <div>
        <div>
          <h1 className=" text-center font-medium  text-5xl mt-10 mb-4 font-body text-slate-700">
            {title}
          </h1>
          <h5 className=" text-center font-body text-slate-700 text-xl font-normal mt-0">
            {description}
          </h5>
        </div>
